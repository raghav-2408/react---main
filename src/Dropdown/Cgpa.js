...
export default function Cgpa() {
  ...
  return (
    <>
      <div>
        <>
          <div className="container my-4 text-center" style={{border : "0px solid white", width : "225px"}} >
            <div id="semesterContainer" style={{width : "100px"}}>

            </div>
          </div>
            <div className="bttnn">
              <button className="btn btn-success mx-4" onClick={add}>Add Semester +</button>
